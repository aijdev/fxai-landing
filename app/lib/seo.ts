...
type BuildMetadataInput = {
  ...
  locale: Locale;
  keywords?: string[];
  /** When true, use `title` verbatim instead of the "%s · FxAI" template. */
  absoluteTitle?: boolean;
  /**
   * Marketing pages get reciprocal hreflang alternates. Legal pages (English
   * only) set this false so they advertise a single English canonical.
   */
  alternates?: boolean;
};
 ...
 * x-default), OpenGraph (with og:locale + alternates), Twitter card, and robots.
 * The file-based `opengraph-image` is merged in automatically by Next.
 */
